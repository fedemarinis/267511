...
### So, the algorithm we are going to implement, uses a similarity measure, more in particular cosine similarity, to determine how much two items match each other based on their characteristics.
